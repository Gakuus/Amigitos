        ...
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-pastel-muted dark:text-slate-400 text-sm mt-1.5">Crea tu cuenta y adopta mascotas</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-pastel-muted dark:text-slate-400 uppercase tracking-wider">Nombre</label>
              <div className="relative">
                <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-pastel-purple/50 dark:text-slate-500" />
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-pastel-muted dark:text-slate-400 uppercase tracking-wider">Confirmar Contraseña</label>
              <div className="relative">
                <Lock size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-pastel-purple/50 dark:text-slate-500" />
          ...
          <p className="text-center text-sm text-pastel-muted dark:text-slate-400">
            ¿Ya tienes cuenta?{' '}
            <Link href="/login" className="text-pastel-purple dark:text-brand-400 hover:text-pastel-purple-dark dark:hover:text-brand-300 font-semibold">
